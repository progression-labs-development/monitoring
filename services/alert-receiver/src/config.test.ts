...
describe("config", () => {
  ...
  it("parses valid environment variables", () => {
    ...
    expect(config.WEBHOOK_SECRET).toBe("test-secret");
  });
  ...
  it("allows optional WEBHOOK_SECRET", () => {
    const { WEBHOOK_SECRET: _, ...envWithoutSecret } = validEnv;
  ...
  it("throws on missing INCIDENT_LEDGER_URL", () => {
